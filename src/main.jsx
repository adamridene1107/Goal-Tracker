  ...
  return (
    <Suspense fallback={<Spinner />}>
      {path === "/subscribe" ? <Subscription /> :
       ...
       <App user={session} onLogout={() => { localStorage.removeItem("gt_session"); const s = JSON.parse(localStorage.getItem("gt_settings")||"{}"); s.theme="dark"; localStorage.setItem("gt_settings",JSON.stringify(s)); window.location.href = "/" }} />}
    </Suspense>
  )
}
